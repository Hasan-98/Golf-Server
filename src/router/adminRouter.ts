...
adminRouter.put('/update-event-by-id/:id', upload.array('mediaFiles[]'), updateEventById);
...
adminRouter.put('/update-event-media', upload.array('mediaFiles[]'), updateEventMedia);
...
adminRouter.put('/edit-comment', editComment);adminRouter.post('/add-score-card', addScoreCard);
...
adminRouter.get('/get-teacher-booked-appointments', getTeacherBookedAppointments);
...
adminRouter.put('/update-post-media', upload.array('mediaFiles[]'), updatePostMedia);
